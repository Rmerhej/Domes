    ...
    <body class="container">
        ...
        <img src="images/pexels-katarzyna-modrzejewska-1314550.jpg" class="img-fluid" alt="...">
        <br>
        <br>
        ...
        <div class="d-flex justify-content-between">
            ...
            <form action="/tocateg?name=4" method="post"><button type="submit">
                <img alt="poisson" class="rounded" id="img1Index"
                src="images/fighting-fish-on-black-background.jpg"> </button></form>
                <p style="color: orange">poissons</p>
            </div>
            <div>
            <form action="/tocateg?name=2" method="post"><button type="submit"> <img alt="chat" class="rounded" id="img2Index"
                src="images/the-red-or-white-cat-i-on-white-studio.jpg"> </button></form>
                <p style="color: orange">chats</p>
            </div>
            <div>
                    <form action="/tocateg?name=1" method="post"><button type="submit">
                    <img alt="chien" class="rounded" id="img3Index" width="75" height="75"
                    src="images/pexels-chevanon-photography-1108099.jpg"> </button></form>
                <p style="color: orange">chiens</p>
            </div>
            <div>
            <form action="/tocateg?name=6" method="post"><button type="submit" ><img alt="oiseau" class="rounded" id="img4Index"
            src="images/closeup-shot-of-male-hawfinch-sitting-on-branch.jpg">  </button></form>
                <p style="color: orange">oiseaux</p>
            </div>
            <div>
            <form action="/tocateg?name=5" method="post"><button type="submit"> <img alt="reptil" class="rounded" id="img5Index"
                 src="images/green-lizard-on-branch-green-lizard-sunbathing-on-branch-green-lizard-climb-on-wood.jpg"
                 height="75" width="75"> </button></form>
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the
                        card title and make up the bulk of the card</p>
    ...
    <button type="submit"  class="btn btn-primary">CONSULTER LE CATALOGUE</button>
            ...
            <div class="card" style="width: 18rem;">
                <img src="images/pexels-richard-segal-1618606.jpg"
                    class="card-img-top" alt="#">
                <div class="card-body">
